...
// Cada Estructura apoint para representar un punto con su coordenada (x,y) y valor resultante
...
void crearMatrices(const char*, int*, int*, int*, int*, int***, int***); //nombre archivo, filasA, colA, filasB, colB, matrizA, matrizB
